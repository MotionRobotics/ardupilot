...
bool ModeSurfaceLand::init(bool ignore_checks)
{
...
#if PRECISION_LANDING == ENABLED
bool ModeSurfaceLand::do_precision_loiter()
{
...
void ModeSurfaceLand::precision_loiter_xy()
{
    loiter_nav->clear_pilot_desired_acceleration();
...
void ModeSurfaceLand::run()
{
    ...
    case AltHold_Flying:
        ...
        //float a = copter.rangefinder.state[0].distance_m;
    //state.distance_m = 1;
...
uint32_t ModeSurfaceLand::wp_distance() const
{
    return loiter_nav->get_distance_to_target();
}

int32_t ModeSurfaceLand::wp_bearing() const
{
